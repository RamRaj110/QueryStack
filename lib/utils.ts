...
// Tech icon mapping - created once at module load for performance
const TECH_ICON_MAP: { [key: string]: string } = {
...
export const getIconClassName = (iconName: string) => {
  ...
  return TECH_ICON_MAP[normalizedIconName]
    ? `${TECH_ICON_MAP[normalizedIconName]} colored`
...
// Tech description mapping - created once at module load for performance
const TECH_DESCRIPTION_MAP: { [key: string]: string } = {
  javascript:
